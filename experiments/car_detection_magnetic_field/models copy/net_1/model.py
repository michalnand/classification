...
class Create(torch.nn.Module):
    ...
    def __init__(self, input_shape, output_shape):
        ...
        self.layers = [ 
                        nn.Conv1d(channels, 16, kernel_size = 5, stride = 2, padding = 0),
                        nn.ReLU(),  #length = 255

                        nn.Dropout(p=0.01),
                        nn.Conv1d(16, 16, kernel_size = 5, stride = 2, padding = 0),
                        nn.ReLU(),  #length = 127
                        ...
                        nn.Dropout(p=0.01),
                        nn.Conv1d(32, 64, kernel_size = 5, stride = 2, padding = 0),
                        nn.ReLU(),  #length = 31
                        ...
                        Flatten(), 
                        nn.Dropout(p=0.01),
                        nn.Linear(13*64, output_shape[0])
        ]
